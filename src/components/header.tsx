...
export default function Header() {
  ...
  return (
    <div className="w-[calc(100%-80px)] text-white fixed z-20 flex justify-between items-center top-16 left-10 rounded-full border-[1px] border-[#504E4E] px-10 py-5 backdrop-blur-md bg-black/30">
